...
/*******************************************************************************
* Function Name  : DFU_Unit_Config.
* Description    : Configures the Soleris unit for DFU Mode.
* Input          : None.
* Output         : None.
* Return         : None.
*******************************************************************************/
void DFU_Unit_Config(void)
{  
  /* Configure the drawer interface */
  STM_Soleris_Unit_Init();
...
* Return         : None
*******************************************************************************/
uint8_t Delay(uint32_t nCount)
{
  TimingDelay = 1;

  while(TimingDelay != 0);  /* sync up with the interrupt */
...
* Description    : Decrements the TimingDelay variable. Called by the timer
*                       interrupt routine.
* Input          : None
* Output         : TimingDelay
* Return         : None
